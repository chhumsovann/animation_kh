...
class AnimationKh extends StatefulWidget {
  final int? position;
  final int? itemCount;
  final Widget? child;
  ...
  @override
  AnimationKhState createState() => AnimationKhState();
}

class AnimationKhState extends State<AnimationKh> {
  @override
